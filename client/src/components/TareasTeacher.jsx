    ...
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <div className="w-64 bg-blue-600 text-white p-6 flex flex-col space-y-6">
        ...
        <ul className="space-y-4 flex-1">
          <li>
            <Link to="/profesor-perfil" className="hover:bg-blue-500 p-2 rounded">
              Mi Perfil
            </Link>
          </li>
          <li>
            <Link to="/profesor-cursos" className="hover:bg-blue-500 p-2 rounded">
              Mis Cursos
            </Link>
          </li>
          <li>
            <Link to="/profesor-tareas" className="hover:bg-blue-500 p-2 rounded">
              Tareas
            </Link>
          </li>
          <li>
            <Link to="/profesor-foros" className="hover:bg-blue-500 p-2 rounded">
              Foros
            </Link>
          </li>
        </ul>
