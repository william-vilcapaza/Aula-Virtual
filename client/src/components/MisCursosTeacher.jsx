  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <div className="flex-1 p-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">Bienvenido, Profesor</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {courses.map((course) => (
            <div key={course.id} className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
              ...
              <Link to={`/cursoteacher/${course.id}`} className="mt-4 inline-block text-indigo-600 hover:text-indigo-800">
                Ver Curso
              </Link>
            </div>
          ))}
